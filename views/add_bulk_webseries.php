...
<html lang="en">
            				...
            				<div class="col-sm-6">
            					...
            					<div class="page-title-box">
            						...
            						<ol class="breadcrumb mb-0">
            							...
            							<li class="breadcrumb-item active">Bulk WebSeries Importer</li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-body">
                                        ...
                                        <h3 class="card-title mt-0">Import WebSeries (<a
    ...
    <script>
                                ...
                                if (!TMDB_ID == "") {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response2) {
                                            ...
                                            add_series(TMDB_ID, NAME, DESCRIPTION, GENRE_list, RELEASE_DATE, THUMBNAIL, Poster, trailler_youtube_source);
                                        }
        ...
        function add_series(IMDB_ID,Name,DESCRIPTION,GENRES,RELEASE_DATE,THUMBNAIL,POSTER,trailler_youtube_source) {
