...
<!--                				</div>-->
                		...
                		<div class="row justify-content-center searchByTitle">
                            <div class="col-lg-6">
                                <div class="input-group flex-nowrap" data-target-input="nearest">
                                    ...
                                    <select class="form-control" id="content_title" type="text"
                                            placeholder="Search for a movie" value="" id="example-text-input"></select>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    <h6>
                                        <p> Get Content Title from here: <a href="https://www.themoviedb.org/movie/"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#content_title").select2({
                    ajax: {
                        url: "https://cloud.team-dooo.com/Dooo/TMDB/index.php",
                        dataType: 'json',
                        delay: 250,
                        data: function (params) {
                            return {
                                query: params.term,
                                code: "<?php echo $config->license_code; ?>",
                                filter: "search",
                                type: "movie",
                ...
                function formatRepo (repo) {
                    ...
                    var $container = $(
                     ...
                     $container.find(".release_date").text(repo.release_date);
                     $container.find(".overview").text(repo.overview.substring(0,150)+"...");
                    return $container;
                }

                function formatRepoSelection (repo) {
                    initMoviesData(repo.id, false);
            ...
            function Load_Movie_Data() {
                ...
                if(contentDataSourceType == "TMDB") {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "https://cloud.team-dooo.com/Dooo/TMDB/?code="+"<?php echo $config->license_code; ?>"+"&filter=find&id="+TMDB_ID,
                        dataType: 'json',
            ...
            function initMoviesData(IMDB_ID, noAlert=false) {
                ...
                if (IMDB_ID != '') {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "https://cloud.team-dooo.com/Dooo/TMDB/?code="+"<?php echo $config->license_code; ?>"+"&filter=single&type=movie&id="+ IMDB_ID +"&id_type=TMDB&language="+tmdb_language+"&image_storage_provider="+"<?php echo $config->image_storage_provider; ?>"+"&key="+"<?php echo $config->imgbb_api_key; ?>",
                        dataType: 'json',
                        beforeSend: function () {
                        ...
                        success: function (response) {
                            if(response != false) {
                                ...
                                if (!TMDB_ID == "") {
                                    ...
                                    $.ajax({
                                        type: 'GET',
                                        url: "https://cloud.team-dooo.com/Dooo/TMDB/video.php?id="+IMDB_ID+"&type=movie&code="+"<?php echo $config->license_code; ?>",
                                        dataType: 'json',
